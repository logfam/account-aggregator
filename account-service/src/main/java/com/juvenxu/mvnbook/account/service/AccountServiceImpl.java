...
import com.juvenxu.mvnbook.account.emaill.AccountEmailException;
import com.juvenxu.mvnbook.account.emaill.AccountEmailService;
...
public class AccountServiceImpl implements AccountService {
	...
	@Override
	public String signUp(SignUpRequest signUpRequest) throws AccountServiceException {
		try {
			...
			String htmlLink = "<a href=\""+link+"\">"+"点击激活账户"+"</a>";

			accountEmailService.sendMail(account.getEmail(), "Please Activate Your Account", htmlLink);
			return link;
		} catch (AccountCaptchaException e) {
